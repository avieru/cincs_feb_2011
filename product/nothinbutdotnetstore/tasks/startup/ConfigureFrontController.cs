...
namespace nothinbutdotnetstore.tasks.startup
{
    public class ConfigureFrontController : StartupCommand
    {
        ...
        public void run()
        {
            ...
            container_services.register<ActiveContextResolver>(() => HttpContext.Current);
            container_services.register<FormPathRegistry, StubFormPathRegistry>();
            container_services.register<PageFactory>(BuildManager.CreateInstanceFromVirtualPath);
